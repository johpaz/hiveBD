...
pub enum EventKind {
    ...
    /// A learning proposal generated by the harness and persisted for auditing.
    LearningProposal,
}
...
impl EventKind {
    ...
    pub fn tag(&self) -> &'static str {
        match self {
            ...
            EventKind::LearningProposal => "LearningProposal",
        }
    }
}
...
impl From<&EventKind> for EventKindTag {
    fn from(kind: &EventKind) -> Self {
        match kind {
            ...
            EventKind::LearningProposal => EventKindTag::LearningProposal,
        }
    }
}
...
impl Event {
    ...
    /// Deserialize the event payload into a typed value.
